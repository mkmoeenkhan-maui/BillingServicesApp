...
namespace ParlourPro.ViewModels
{
    public partial class ServiceBillingViewModel : ObservableObject
    {
        ...
        [ObservableProperty] ServiceMaster selectedService;
        [ObservableProperty]
        ...
        partial void OnSelectedServiceChanged(ServiceMaster value)
        {
            if (value != null)
            {
        ...
        public ServiceBillingViewModel(IParlourService parlourService, FirebaseService firebaseService)
        {
